...
public class LightningSystem : MonoBehaviour
{
    ...
    [Header("Cloud Illumination")]
    public DarkCloudSystem cloudSystem;
    public float cloudIlluminationRadius = 250f;
    ...
    void Start()
    {
        ...
        // Find cloud system if not assigned
        if (cloudSystem == null)
        {
            cloudSystem = FindObjectOfType<DarkCloudSystem>();
        }
    ...
    IEnumerator Strike()
    {
        ...
        if (cloudSystem != null)
        {
            cloudSystem.IlluminateClouds(strikePos, cloudIlluminationRadius);
        }
